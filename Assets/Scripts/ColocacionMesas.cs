...
public class ColocacionMesas : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other) // to see when the player enters the collider
    {
        ...
        if (other.gameObject.tag != "Untagged" && other.gameObject.tag != "Player" && other.gameObject.tag != "Cuchillo" && other.gameObject.tag != "Extintor" && other.gameObject.transform.parent != myHands.transform)
        {
            posicionar = true;  
